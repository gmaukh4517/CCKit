...
- (void)viewDidLoad {
    ...
    if (!tzImagePickerVc.sortAscendingByModificationDate && _isFirstAppear && PhotoiOS8Later) {
        ...
        if (_showTakePhotoBtn || !PhotoiOS8Later || _isFirstAppear) {
...
- (void)takePhoto {
    ...
    if ((authStatus == AVAuthorizationStatusRestricted || authStatus ==AVAuthorizationStatusDenied) && PhotoiOS7Later) {
        // 无权限 做一个友好的提示
