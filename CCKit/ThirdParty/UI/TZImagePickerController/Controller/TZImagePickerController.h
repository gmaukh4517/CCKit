...
#define PhotoiOS7Later ([UIDevice currentDevice].systemVersion.floatValue >= 7.0f)
#define PhotoiOS8Later ([UIDevice currentDevice].systemVersion.floatValue >= 8.0f)
#define PhotoiOS9Later ([UIDevice currentDevice].systemVersion.floatValue >= 9.0f)
