         ...
         success:(requestDownloadsuccess)success
{
    ...
    NSURLSessionDownloadTask *downloadTask = [manager downloadTaskWithRequest:request progress:nil destination:^NSURL *(NSURL *targetPath, NSURLResponse *response) {
        ...
        NSString *documentsDirectory = [NSString stringWithFormat:@"%@/Download/%@",documentFolder,[arr objectAtIndex:arr.count - 2]];
        ...
        NSURL *downloadURL = [documentsDirectoryURL URLByAppendingPathComponent:[NSString stringWithFormat:@"%@.%@",[CCHTTPUpDownLoad UUID],expand]];
