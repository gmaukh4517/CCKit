...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    super.topViewController.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:nil];
...
+ (UIImage *)imageNamedFromMyBundle:(NSString *)name {
    ...
    NSString *imagePath = [imageBundle pathForResource:[NSString stringWithFormat:@"PhotoPicker/%@",name] ofType:@"png"];
