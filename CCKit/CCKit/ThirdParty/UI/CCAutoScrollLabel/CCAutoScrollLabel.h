...
@interface CCAutoScrollLabel : UIView

typedef NS_ENUM(NSInteger, CCAutoScrollDirection) {
    CCAutoScrollDirectionRight,
    CCAutoScrollDirectionLeft
};

@property (nonatomic) CCAutoScrollDirection scrollDirection;
